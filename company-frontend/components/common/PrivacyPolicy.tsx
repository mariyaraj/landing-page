...
const PrivacyPolicy = () => (
  <div className="text-gray-700">
    <p><strong>1. Name und Kontaktdaten des Verantwortlichen</strong></p><br />
    <p>
      Mariya Rajendran mit AI2Connect in Planung<br />
      Süggelberg 6<br />
      44339 Dortmund<br />
      Deutschland<br />
    </p>
    <br />
    <p>Verantwortlich für den Inhalt: Mariya Rajendran</p>
    <br />
    <p className="text-gray-700 mt-4">
      Kontakt:<br />
      Telefon: +49 (0)123 456789<br />
      E-Mail: <a href="mailto:info@ai2connect-do.com">info@ai2connect-do.com</a>
    </p><br />

    <p><strong>2. Erhebung und Speicherung personenbezogener Daten sowie Art und Zweck der Verwendung</strong></p><br />
    <p>
    ...
    <p>
      Personenbezogene Daten werden nur so lange gespeichert, wie dies für die jeweiligen Zwecke erforderlich ist. Die Daten aus Terminbuchungen und Bewerbungen von Pilotkunden oder Anbietern werden nach der Erfüllung des Zwecks gelöscht, sofern keine gesetzlichen Aufbewahrungsfristen entgegenstehen.
    </p><br />

    <p><strong>6. Rechte der Betroffenen</strong></p><br />
    <div>
      Nutzer haben das Recht:
      <ul className="list-disc ml-6">
        <li>gemäß Art. 15 DSGVO Auskunft über die von uns verarbeiteten personenbezogenen Daten zu verlangen.</li>
        <li>gemäß Art. 16 DSGVO unverzüglich die Berichtigung unrichtiger oder die Vervollständigung der bei uns gespeicherten personenbezogenen Daten zu verlangen.</li>
        <li>gemäß Art. 17 DSGVO die Löschung ihrer bei uns gespeicherten personenbezogenen Daten zu verlangen, soweit keine gesetzlichen Anforderungen dem entgegenstehen.</li>
    ...
    <p><strong>7. Beschwerderecht</strong></p><br />
    <p>
      Jeder Betroffene hat das Recht, sich bei einer Aufsichtsbehörde zu beschweren, insbesondere in dem Mitgliedstaat seines Aufenthaltsorts, seines Arbeitsplatzes oder des Orts des mutmaßlichen Verstoßes.
    </p><br />

    <p><strong>8. Verwendung von Cookies</strong></p><br />
    <p>
